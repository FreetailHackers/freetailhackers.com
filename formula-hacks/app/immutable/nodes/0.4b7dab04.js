...
function wl(f) {
    ...
    return de = new Il({}), {
        ...
        l(_) {
            ...
            var Se = p(Z);
            Se.forEach(i), M.forEach(i), Ee = E(g), N && N.l(g), g.forEach(i), _e = E(_), R && R.l(_), Ae = E(_), z.l(_), Ie = E(_), tl(de.$$.fragment, _), Ce = E(_), me = v(_, "FOOTER", {
                class: !0
            });
            var jt = p(me);
            P = v(jt, "DIV", {
        ...
        d(_) {
            _ && i(t), f[7](null), H && H.d(), C && C.d(), F && F.d(), O && O.d(), T && T.d(), f[8](null), N && N.d(), _ && i(_e), R && R.d(_), _ && i(Ae), z.d(_), _ && i(Ie), al(de, _), _ && i(Ce), _ && i(me)
        }
    }
}
